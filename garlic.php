		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-11.jpg" class="image-popup"><img src="images/product-11.jpg" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>Garlic Improves Cholesterol Levels, Which May Lower the Risk of Heart Disease. </p>
					<div class="row mt-4">
						<div class="col-md-6">
                    ...
                    <form method="POST" action ="garlic.php">
