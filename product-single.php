		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p class="price"><span>₹46.45</span></p>
					<p>Bell peppers are an excellent source of vitamin C and also contain vitamins A, B6, and K,
						potassium, folic acid, fiber, and beta-carotene.</p>
					<div class="row mt-4">
						<div class="col-md-6">
