				...
				<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
					<div class="cart-total mb-3">
						...
						<p class="d-flex">
							<span>Subtotal</span>
							<span><?php 
							 $_SESSION['cost'] = $_SESSION['cost1']+$_SESSION['cost2']+$_SESSION['cost3']+$_SESSION['cost4']+$_SESSION['cost5']+$_SESSION['cost6']+$_SESSION['cost7']+$_SESSION['cost8']+$_SESSION['cost9']+$_SESSION['cost10']+$_SESSION['cost11']+$_SESSION['cost12'];
							 echo $_SESSION['cost'];
