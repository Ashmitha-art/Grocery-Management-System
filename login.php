            ...
            <div class="row justify-content-end">
                <div class="col-md-4 heading-section ftco-animate deal-of-the-day ftco-animate">
                    <form method='POST' action='login.php'
                        style="text-align:center;border:5px solid rgb(129,174,64);background-color:black;border-radius:25px;opacity:0.9;">
                        <h2 style="color:rgb(129,174,64);text-align:center;">Log In </h2>
                        <i class="icon-user ">&nbsp;&nbsp;</i><input type="text" name="Email"
                        ...
                        <input type="submit" style="justify-contents:center;" class="btn btn-md btn-primary"
                            name="submit" value="Login"><br><br>
...
if (isset($_POST['submit'])) {
  ...
  echo '<span style="color:red;font-size:1.7rem;margin-left:70%;padding-top:-60%;">'.$fail.'</span>';
