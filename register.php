...
if (isset($_POST['submit'])) {
   ...
   echo '<span style="color:red;font-size:1.7rem;margin-left:70%;padding-top:-60%;">'.$fail1.'</span>';
    ...
    if(!$ruhi)                       
    echo '<span style="color:red;font-size:1.7rem;margin-left:60%;padding-top:-60%;">'.$fail.'</span>';
