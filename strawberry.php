		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>They're an excellent source of vitamin C and manganese and also contain decent amounts of folate
						(vitamin B9) and potassium.</p>
					<div class="row mt-4">
						<div class="col-md-6">
					...
					<form method="POST" action ="strawberry.php">
