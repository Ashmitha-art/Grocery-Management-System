							...
							<div class="col-md-12">
								<div class="cart-detail p-3 p-md-4">
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
												<label><input type="radio" name="optradio" value="bank transfer"
														class="mr-2" required> Direct Bank Tranfer</label>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
												<label><input type="radio" name="optradio" class="mr-2"
														value="check payment" required> Check Payment</label>
											</div>
										</div>
									</div>
									<div class="form-group">
									...
									<p><input type="submit" name="place" value="Place an Order"
											class=" btn btn-primary submit px-3"></p>
								</div>
							</div>
						</div>
	</form>
...
if (isset($_POST['submit'])) {
    ...
    if($ruhi)
    {
        ...
        echo 'alert("Placed order successfully!");'; 
