		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-7.jpg" class="image-popup"><img src="images/product-7.jpg" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>It is crunchy, tasty, and highly nutritious. Carrots are a particularly good source of beta carotene, fiber, vitamin K1, potassium, and antioxidants. </p>
					<div class="row mt-4">
						<div class="col-md-6">
                    ...
                    <form method="POST" action ="carrots.php">
