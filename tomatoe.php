		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p class="price"><span>₹22.84</span></p>
					<p>Tomatoes are the major dietary source of the antioxidant lycopene, which has been linked to many
						health benefits, including reduced risk of heart disease and cancer. They are also a great
						source of vitamin C, potassium, folate, and vitamin K.</p>
					<div class="row mt-4">
						<div class="col-md-6">
					...
					<form method="POST" action="tomatoe.php">
