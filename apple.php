		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-10.jpg" class="image-popup"><img src="images/product-10.jpg"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>The phytonutrients and antioxidants in apples may help reduce the risk of developing cancer,
						hypertension, diabetes, and heart disease. </p>
					<div class="row mt-4">
						<div class="col-md-6">
                    ...
                    <p><input type="submit" name="add" value="Add to Cart" class="submit btn btn-primary px-3"></p>
</form>
				</div>
			</div>
		</div>
