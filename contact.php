...
<body class="goto-here">
  ...
  <div class="hero-wrap hero-bread" style="background-image: url('images/bg_17.jpg');">
    <div class="container">
      ...
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="col-md-3 d-flex">
          <div class="info bg-white p-4">
            <p><span>Address:</span> <a>203 Fake St. Mountain
                View, Bangalore, India</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="info bg-white p-4">
            <p><span>Phone:</span> <a href="tel://1234567920">+91 9449101299</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="info bg-white p-4">
            <p><span>Email:</span> <a href="mailto:info@yoursite.com">grocers@gmail.com</a></p>
          </div>
        </div>
        <div class="col-md-3 d-flex">
          <div class="info bg-white p-4">
            <p><span>Website</span> <a href="#">grocer.com</a></p>
          </div>
        </div>
      </div>
...
if (isset($_POST['submit'])) {
    ...
    $ruhi=mysqli_query($conn,"Insert into feedback(name,email,subject,message) values('$n','$e','$s','$m')");
