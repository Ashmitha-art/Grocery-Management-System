		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-3.jpg" class="image-popup"><img src="images/product-3.jpg" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>Young, tender green beans are a good source of vitamin C, dietary fiber, folate, vitamin K and silicon (needed for healthy bones, skin, and hair).</p>
					<div class="row mt-4">
						<div class="col-md-6">
					...
					<form method="POST" action ="greenbeans.php">
