		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-4.jpg" class="image-popup"><img src="images/product-4.jpg" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>Reduces inflammation, a healthier heart, stronger bones, improved gut function, and perhaps even
						a lower risk of certain cancers.</p>
					<div class="row mt-4">
						<div class="col-md-6">
                    ...
                    <form method="POST" action ="purplecabbage.php">
