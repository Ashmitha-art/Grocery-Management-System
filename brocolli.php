		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 mb-5 ftco-animate">
					<a href="images/product-6.jpg" class="image-popup"><img src="images/product-6.jpg" class="img-fluid"
				...
				<div class="col-lg-6 product-details pl-md-5 ftco-animate">
					...
					<p>A good source of folate (folic acid) and also provides potassium, fiber. Vitamin C – builds collagen, which forms body tissue and bone, and helps cuts and wounds heal.</p>
					<div class="row mt-4">
						<div class="col-md-6">
					...
					<form method="POST" action ="brocolli.php">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<div class="d-flex">
								...
								<p class="price"><span class="mr-2 price-dc">₹66.00</span><span
											class="price-sale">₹46.45</span></p>	</div>
							</div>
